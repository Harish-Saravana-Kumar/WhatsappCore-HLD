...
public class RestServer {
    ...
    public void start() {
        try {
            ...
            server.createContext("/api/chats/send", new SendMessageHandler());            server.createContext("/api/chats/messages", new GetMessagesHandler());            server.createContext("/api/groups", new GetGroupsHandler());
    ...
    private class SendMessageHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                // Add message to group if groupId is provided
                if (!groupId.isEmpty()) {
    ...
    private class GetMessagesHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (query != null) {
                if (query.contains("senderId=")) {
                    senderId = query.split("senderId=")[1].split("&")[0];
                }
            ...
            if (groupId != null && !groupId.isEmpty()) {
                ...
                messages = messageRepository.getMessagesBySender(senderId);
            } else {
