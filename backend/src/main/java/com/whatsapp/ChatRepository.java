...
public class ChatRepository {
    ...
    // Get private chat between two users (alias for getChatBetweenUsers)
    public Chat getPrivateChat(String userId1, String userId2) {
        return getChatBetweenUsers(userId1, userId2);
    }
